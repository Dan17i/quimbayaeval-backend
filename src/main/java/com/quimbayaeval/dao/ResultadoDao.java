...
public class ResultadoDao {
     ...
     * Nota en escala 1-5: nota = 1 + (porcentaje / 100) * 4
     * Usado por docentes.
     */
    ...
    public List<ResumenCursoDTO> findResumenByCurso(Integer cursoId) {
        String sql =
            ...
            "ROUND(CAST(AVG(r.porcentaje) AS numeric), 2) as promedio_grupo, " +
            "ROUND(CAST(1 + (AVG(r.porcentaje) / 100.0) * 4 AS numeric), 2) as promedio_escala, " +
        ...
        return jdbcTemplate.query(sql, (rs, rowNum) -> {
            ...
            dto.setPromedioEscala(rs.getBigDecimal("promedio_escala"));
